...
SMODS.Back {
    ...
    calculate = function(self, card, context)
        if context.main_eval then
            G.GAME.interest_cap = G.GAME.interest_cap + back.ability.extra.interest_cap0
            G.GAME.round_resets.reroll_cost = G.GAME.round_resets.reroll_cost + back.ability.extra.reroll_cost0
            G.GAME.current_round.reroll_cost = math.max(0, G.GAME.current_round.reroll_cost + back.ability.extra.reroll_cost0)
            return {
